...
function share({ data, origin }) {
  ...
  const copyUrl = () => {
    navigator.clipboard.writeText(
      `${origin}/user/${data.token}/${data.uniqid}`
    );
  };
            ...
            <h2  style={{fontFamily: '"Poppins", sans-serif', fontWeight: '700'}}>
              <font style={{ verticalAlign: "inherit" }}>
                <font style={{ verticalAlign: "inherit", color: "#EB144F" }}>
                  {data.votingFor.toUpperCase()} & {data.name.toUpperCase()}
                </font>
              </font>
            </h2>
            <div
          ...
          <div className="deckurl">
            <div className="inner">
              ...
              <div style={{ display: "flex", fontFamily: '"Poppins", sans-serif', fontWeight: '700' }} className="copyUrl">
                <input
                  type="text"
                  defaultValue={`${origin}/user/${data.token}/${data.uniqid}`}
              ...
              <div className="sns">
                <a
                  target="_blank"
                  rel="noreferrer"
                  href={`https://api.whatsapp.com/send?text=${origin}/user/${data.token}/${data.uniqid}`}
                  data-action="share/whatsapp/share"
                >
                  <img src="/whatsapp.png" alt="whatsapp" />
                </a>
                <a
                  href={`https://social-plugins.line.me/lineit/share?url=https://twitter.com/share?url=${origin}/user/${data.token}/${data.uniqid}`}
                >
                  <img src="/ico_line.png" alt="line" />
                </a>
                <a
                  href={`http://www.facebook.com/share.php?u=${origin}/user/${data.token}/${data.uniqid}`}
                  target="_blank"
                  rel="noreferrer"
                  className="facebook"
                >
